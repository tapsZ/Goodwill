 ...
 */
@Stateless
@Path("com.mycompany.goodwill.insurance.orderstatus")
public class OrderStatusFacadeREST extends AbstractFacade<OrderStatus> {
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") Integer id, OrderStatus entity) {
        super.edit(entity);
    }
    ...
    public OrderStatus find(@PathParam("id") Integer id) {
    ...
    @Path("{from}/{to}")
    @Produces({"application/xml", "application/json"})
    public List<OrderStatus> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
